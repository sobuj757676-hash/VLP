    ...
    >
      ...
      <main className="container mx-auto py-16 px-4 flex-grow">
        <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 max-w-4xl mx-auto border border-gray-100">
          <h1 className="text-4xl font-extrabold mb-8 text-gray-900 border-b pb-6">Privacy Policy</h1>
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: product.legal?.privacy_policy_html || '<p>No privacy policy available.</p>' }}
          />
        </div>
      </main>
